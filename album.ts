...
function make_album(music_album:{artist_name:string;album_title:string;NoOfTrack?:number}){
//console.log("Artist name is: ",artist_name,"Artist album is: ",album_title);

return music_album;

}
function three_dictionaries(dictionaries:{album1:string;album2:string;album3:string}){
